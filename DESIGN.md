...
| 2026-09-12 | 失败原因空态 metrics 导出附带报告 meta | writeStudioReportMetaJSON + emptyStateMetricsReportMeta |
...
| 2026-09-12 | 失败原因空态 metrics 贴 issue 短卡片 | Shift+点击；含预设与 kind；formatEmptyStateMetricsIssueShortMarkdown |
