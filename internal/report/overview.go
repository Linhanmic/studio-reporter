...
func writeFailReasonSection(b *bytes.Buffer, groups []FailReasonGroup) {
	...
	b.WriteString("<button type=\"button\" class=\"action-btn action-btn-tiny overview-empty-state-metrics-meta-preset-chip\" id=\"overview-empty-state-metrics-meta-preset-chip\" data-action=\"open-empty-state-metrics-meta-fields\" data-named-preset=\"\" title=\"当前 meta 字段命名预设；点击打开字段编辑器\">预设·默认</button>")
